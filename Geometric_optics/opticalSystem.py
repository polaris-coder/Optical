...
class LensSys():
    ...
    def calEfl(self):
        ...
        axial_rays = self.ParaxialRayTrace(ray)
        # 计算焦距
        efl = -(axial_rays[self.num_lens - 3]['y'] / axial_rays[self.num_lens - 2]['u'])
        self.Lens[self.num_lens - 2]['t'] = efl
